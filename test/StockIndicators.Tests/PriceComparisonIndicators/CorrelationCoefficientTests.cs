using StockIndicators.PriceComparisonIndicators;
using Microsoft.VisualStudio.TestTools.UnitTesting;

namespace StockIndicators.Tests.PriceComparisonIndicators;
...
public class CorrelationCoefficientTests
{
    ...
    public void CorrelationCoefficient()
    {
        ...
        for (var i = 0; i < 20; i++)
        {
            indicator.Add(new Price { Close = prices1[i] }, new Price { Close = prices2[i] });
        }
