...
/// <summary>
/// Settings for the <see cref="SimpleMovingAverage"/> indicator.
/// </summary>
public sealed class SimpleMovingAverageSettings
{
    /// <summary>
...
public sealed class SimpleMovingAverage : IAverageIndicator, IChartValueSeriesProvider
{
    ...
    public SimpleMovingAverage(IndicatorCapacity capacity)
        : this(capacity, new SimpleMovingAverageSettings())
    { }
    ...
    public SimpleMovingAverage(IndicatorCapacity capacity, SimpleMovingAverageSettings settings)
    {
    ...
    [
        new ChartValueSeries($"SMA ({periods})", Values, ChartValueSeriesStyle.Line)
    ];
}