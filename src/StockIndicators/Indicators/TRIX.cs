...
public sealed class TRIX : IPriceIndicator, IChartProvider
{
    ...
    private readonly ExponentialMovingAverage singleMA;
    private readonly ExponentialMovingAverage doubleMA;
    private readonly ExponentialMovingAverage tripleMA;
    private readonly ExponentialMovingAverage signalMA;
    private double? last;
